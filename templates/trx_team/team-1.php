...
if ( !function_exists( 'prohost_template_team_1_theme_setup' ) ) {
	add_action( 'prohost_action_before_init_theme', 'prohost_template_team_1_theme_setup', 1 );
	function prohost_template_team_1_theme_setup() {
		prohost_add_template(array(
			'layout' => 'team-1',
			'template' => 'team-1',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Team /Style 1/', 'prohost'),
...
// Template output
if ( !function_exists( 'prohost_template_team_1_output' ) ) {
	function prohost_template_team_1_output($post_options, $post_data) {
		$show_title = true;
