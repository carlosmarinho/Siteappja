...
if ( !function_exists( 'prohost_template_services_3_theme_setup' ) ) {
	add_action( 'prohost_action_before_init_theme', 'prohost_template_services_3_theme_setup', 1 );
	function prohost_template_services_3_theme_setup() {
		prohost_add_template(array(
			'layout' => 'services-3',
			'template' => 'services-3',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 3/', 'prohost'),
...
// Template output
if ( !function_exists( 'prohost_template_services_3_output' ) ) {
	function prohost_template_services_3_output($post_options, $post_data) {
