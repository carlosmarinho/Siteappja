...
if ( !function_exists( 'prohost_template_services_5_theme_setup' ) ) {
	add_action( 'prohost_action_before_init_theme', 'prohost_template_services_5_theme_setup', 1 );
	function prohost_template_services_5_theme_setup() {
		prohost_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'prohost'),
...
// Template output
if ( !function_exists( 'prohost_template_services_5_output' ) ) {
	function prohost_template_services_5_output($post_options, $post_data) {
