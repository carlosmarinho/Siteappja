...
if ( !function_exists( 'prohost_template_news_portfolio_theme_setup' ) ) {
	add_action( 'prohost_action_before_init_theme', 'prohost_template_news_portfolio_theme_setup', 1 );
	function prohost_template_news_portfolio_theme_setup() {
		prohost_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'prohost'),
...
// Template output
if ( !function_exists( 'prohost_template_news_portfolio_output' ) ) {
	function prohost_template_news_portfolio_output($post_options, $post_data) {
