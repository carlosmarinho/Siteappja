...
if ( !function_exists( 'prohost_template_testimonials_2_theme_setup' ) ) {
	add_action( 'prohost_action_before_init_theme', 'prohost_template_testimonials_2_theme_setup', 1 );
	function prohost_template_testimonials_2_theme_setup() {
		prohost_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'prohost')
		));
	}
}

// Template output
if ( !function_exists( 'prohost_template_testimonials_2_output' ) ) {
	function prohost_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
